            ...
            {user ? (
              <DropdownMenu open={isUserDropdownOpen} onOpenChange={setIsUserDropdownOpen}>
                <DropdownMenuTrigger className="flex items-center p-1 rounded-full hover:bg-light-blue-bg dark:hover:bg-gray-800 transition-colors duration-200 focus:outline-none">
                  <img src={user.profilePicture || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"} alt="User profile" className="w-8 h-8 rounded-full border border-light-blue-border dark:border-gray-700 shadow-sm" />
                  <span className="hidden md:flex items-center ml-2 text-sm font-medium text-dark-text dark:text-gray-200">
                ...
                <DropdownMenuContent align="end" className="w-56 bg-white dark:bg-gray-800 border dark:border-gray-700 p-1">
                  ...
                  <DropdownMenuItem asChild><Link href="/health-coach">Health Coach</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/connections">Connections</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/family">Family Health</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/messenger">Messenger</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/nutrition">Nutrition</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/longevity">Longevity</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/metabolic">Metabolic Health</Link></DropdownMenuItem>
                  <DropdownMenuItem asChild><Link href="/profile#neural-profile">Neural Profile</Link></DropdownMenuItem>
              ...
              <div className="flex items-center gap-3">
                <Link href="/auth/login" className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-primary border border-light-blue-border dark:border-gray-700 text-sm font-medium hover:bg-light-blue-bg dark:hover:bg-gray-700 transition-colors duration-200">Login</Link>
                <Link href="/auth/register" className="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-primary-blue-hover transition-colors duration-200">Sign Up</Link>
              </div>
            )}
