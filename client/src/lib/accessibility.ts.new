...
/**
 * Skip to content link properties
 * For creating an accessible way for keyboard users to skip navigation
 */
export function getSkipToContentProps(contentId: string): {
  href: string;
  className: string;
  children: string;
} {
